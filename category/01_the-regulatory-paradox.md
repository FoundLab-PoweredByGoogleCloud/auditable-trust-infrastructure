...
| :--- | :--- | :--- | :--- |
| **The Mandate to Retain** | AML/CFT (PLD/FT) law compels conservation of the exact KYC and transaction records of a customer relationship for a minimum **10-year** term; cybersecurity, internal-controls and audit duties additionally require that the integrity of those records be preserved and independently inspectable over multi-year horizons. | **Circular BCB 3.978/2020 (PLD/FT)** *(amended by Res. BCB 282/2022)* — Art. 50, 10-year conservation of KYC records (arts. 13 / 16 / 18) and records of operations (Art. 28) · CMN 4.893/2021 *(as amended by CMN 5.274/2025)* · BCB 538/2025 *(amending BCB 85/2021)* · CMN 4.968/2021 · SOX · EU AI Act Art. 12 | Charges of record/evidence destruction; AML and supervisory penalties. |
