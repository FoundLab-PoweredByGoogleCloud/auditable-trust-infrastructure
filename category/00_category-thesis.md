...
- **The duty to retain.** Cybersecurity, internal-controls, and audit obligations require that the evidence of a decision be preserved, intact and inspectable, for years. (In Brazil: the cybersecurity framework of **CMN 4.893/2021, as amended by CMN 5.274/2025**, and **BCB Resolution 538/2025** amending **BCB 85/2021**; internal-controls obligations under **CMN 4.968/2021**; analogous duties under SOX and the **EU AI Act, Art. 12** logging requirement.)
