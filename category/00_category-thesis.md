...
- **The duty to retain.** AML/CFT, cybersecurity, internal-controls, and audit obligations require that the records and evidence of a decision be preserved, intact and inspectable, for years. (In Brazil the sharpest anchor is the AML/CFT (PLD/FT) record-retention mandate of **Circular BCB 3.978/2020**, as amended by **Res. BCB 282/2022**, which compels conservation of KYC and transaction records for a minimum ten-year term — Art. 50, counted from the first day of the year following the end of the relationship; layered beneath it, the cybersecurity framework of **CMN 4.893/2021, as amended by CMN 5.274/2025**, and **BCB Resolution 538/2025** amending **BCB 85/2021**; internal-controls obligations under **CMN 4.968/2021**; analogous duties under SOX and the **EU AI Act, Art. 12** logging requirement.)
