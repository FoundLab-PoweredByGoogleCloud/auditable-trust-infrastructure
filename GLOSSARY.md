...
- **PLD/FT (Prevenção à Lavagem de Dinheiro e ao Financiamento do Terrorismo)**: Brazil's AML/CFT regime. Its record-retention mandate — **Circular BCB 3.978/2020** (amended by Res. BCB 282/2022), Art. 50, which compels conservation of KYC and transaction records for a minimum ten-year term — is the sharpest legal anchor of the **duty to retain** leg of the **Retention Paradox**. It binds the very personal data that LGPD Art. 18, VI lets a subject demand be erased.
