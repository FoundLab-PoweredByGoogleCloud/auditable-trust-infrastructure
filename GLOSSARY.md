...
- **Retention Paradox**: The structural conflict between a legal **duty to retain** the records and evidence of a decision (AML/CFT — see **PLD/FT** — alongside cybersecurity, internal-controls, and audit obligations) and a legal **duty to erase** the personal data behind it (data-protection law). Both are binding; retaining the data to satisfy one creates a standing violation of the other. ATI dissolves it by giving evidence and personal data *separate lifecycles*.
- **PLD/FT (Prevenção à Lavagem de Dinheiro e ao Financiamento do Terrorismo)**: Brazil's AML/CFT regime. Its record-retention mandate — **Circular BCB 3.978/2020** (amended by Res. BCB 282/2022), Art. 67, which compels retention of client-knowledge information (arts. 13/16/18) and operation records (arts. 28–37) for a minimum **10-year** term — is the sharpest legal anchor of the **duty to retain** leg of the **Retention Paradox**. It binds the very personal data that LGPD Art. 18, VI lets a subject demand be erased.
...
- **REX — canonical naming register**: one spelling per concept — `REX Guard` (the product surface, **β**; no hyphen) · `REX Voice` (the voice-acceptance surface, **α**; no hyphen) · `REX family` (the product family; lowercase *family*, no hyphen) · `REX pattern` (the Rationale-Extraction pattern; lowercase *pattern*). **REX Voice (α) and REX Guard (β) are intentionally distinct surfaces — α attests expressed human consent, β attests the algorithmic decision; do not merge them.**
